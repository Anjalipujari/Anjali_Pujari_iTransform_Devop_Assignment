package Assignment
//a. What data type is the number 2
def a = 2
println a
...
def a1 = 2.0
println a1
println a1.getClass().getName()

//b.Declare a variable x of type def and assign it the sum of 1 and 1.5. 
...
//wanted to do integer division (no remainder)
def int y1 = 5 / 2
println (y1);
